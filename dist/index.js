...
exports.scanTemplate = exports.newConformityApiClient = void 0;
 ...
 */
function newConformityApiClient(apiKey, region = 'au-1') {
    return (0, wretch_1.default)()
        .polyfills({
        fetch: node_fetch_1.default,
        FormData: form_data_1.default,
        URLSearchParams: url_1.default.URLSearchParams,
    })
        .url(`https://conformity.${region}.cloudone.trendmicro.com/api`)
        .auth('ApiKey ' + apiKey)
        .content('application/vnd.api+json');
}
exports.newConformityApiClient = newConformityApiClient;
async function scanTemplate(client, props) {
    var _a;
    const payload = {
        data: {
            attributes: {
                type: (_a = props.templateType) !== null && _a !== void 0 ? _a : 'cloudformation-template',
                contents: (0, fs_1.readFileSync)(props.templateFilePath).toString(),
...
//# sourceMappingURL=data:application/json;base64,
...
const conformity_1 = __nccwpck_require__(6328);
async function run() {
    try {
        const apiKey = core.getInput('apiKey', { required: true });
        const region = core.getInput('region', { required: true });
        const templateFile = core.getInput('templateFile', { required: true });
        const client = (0, conformity_1.newConformityApiClient)(apiKey, region);
        await (0, conformity_1.scanTemplate)(client, {
...
void run();
//# sourceMappingURL=data:application/json;base64,
